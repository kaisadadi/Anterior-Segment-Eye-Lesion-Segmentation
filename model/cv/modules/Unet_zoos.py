...
from model.cv.modules.Unet_utils import init_weights, unetConv2, unetUp, unetConv2_dilation


class UNet_raw(nn.Module):

    def __init__(self, n_channels=3, n_classes=4, feature_scale=2, is_deconv=True, is_batchnorm=True):
        super(UNet_raw, self).__init__()
    ...
    def forward(self, inputs):
        ...
        logits = self.final_1(up1)
        return logits


class UNet_Nested(nn.Module):

    def __init__(self, n_channels, n_classes=4, feature_scale=2, is_deconv=True, is_batchnorm=True, is_ds=True):
    ...
    def forward(self, inputs):
        ...
        logits = (final_1 + final_2 + final_3 + final_4) / 4
...
class UNet_Nested_dilated(nn.Module):
    ...
    def __init__(self, n_channels=3, n_classes=4, feature_scale=2, is_deconv=True, is_batchnorm=True, is_ds=True):
