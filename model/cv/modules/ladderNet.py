...
class LadderNetv6(nn.Module):
    def __init__(self, n_channels, n_classes):
        ...
        layers = 4
        filters = 32
        self.initial_block = Initial_LadderBlock(planes=filters,layers=layers,inplanes=n_channels)
        ...
        self.final = nn.Conv2d(in_channels=filters,out_channels=n_classes,kernel_size=1)
